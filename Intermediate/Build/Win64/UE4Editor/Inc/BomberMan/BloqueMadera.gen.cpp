...
#include "BomberMan/BloqueMadera.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	BOMBERMAN_API UClass* Z_Construct_UClass_ABloqueMadera_NoRegister();
	BOMBERMAN_API UClass* Z_Construct_UClass_ABloqueMadera();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABloqueMadera_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ABloqueMadera_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UIBloqueComponente_NoRegister, (int32)VTABLE_OFFSET(ABloqueMadera, IIBloqueComponente), false },
		};
	...
	IMPLEMENT_CLASS(ABloqueMadera, 3091860257);
	template<> BOMBERMAN_API UClass* StaticClass<ABloqueMadera>()
	{
		return ABloqueMadera::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABloqueMadera(Z_Construct_UClass_ABloqueMadera, &ABloqueMadera::StaticClass, TEXT("/Script/BomberMan"), TEXT("ABloqueMadera"), false, nullptr, nullptr, nullptr);
