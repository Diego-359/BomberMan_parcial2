...
#ifdef BOMBERMAN_BloqueMadera_generated_h
...
template<> BOMBERMAN_API UClass* StaticClass<class ABloqueMadera>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID BomberMan_Source_BomberMan_BloqueMadera_h
