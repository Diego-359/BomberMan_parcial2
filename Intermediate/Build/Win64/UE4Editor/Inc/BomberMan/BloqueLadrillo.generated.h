...
#ifdef BOMBERMAN_BloqueLadrillo_generated_h
...
template<> BOMBERMAN_API UClass* StaticClass<class ABloqueLadrillo>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID BomberMan_Source_BomberMan_BloqueLadrillo_h
